...
(
  ...
  assign hw2reg.target_nack_count.d = event_target_nack ?
                                      hw2reg.target_nack_count.q + 1 :
                                      hw2reg.target_nack_count.q;
  ...
  i2c_fsm #(
    ...
    .event_target_nak_o      (event_target_nak),
